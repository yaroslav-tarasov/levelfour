...
#include "AqtFilterSobelNodePlugin.h"
...
//!
Node * AqtFilterSobelNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new AqtFilterSobelNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(AqtFilterSobelNodePlugin, AqtFilterSobelNodePlugin)
