...
#include "AqtFilterUnsharpMaskNodePlugin.h"
...
//!
Node * AqtFilterUnsharpMaskNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new AqtFilterUnsharpMaskNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(aqtfilterunsharpmasknodeplugin, AqtFilterUnsharpMaskNodePlugin)
