...
#include "ScratchedFilmNodePlugin.h"
...
//!
Node * ScratchedFilmNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new ScratchedFilmNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(ScratchedFilmnodeplugin, ScratchedFilmNodePlugin)
