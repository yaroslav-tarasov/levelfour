...
#include "BadPrintingNodePlugin.h"
...
//!
Node * BadPrintingNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new BadPrintingNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(BadPrintingnodeplugin, BadPrintingNodePlugin)
