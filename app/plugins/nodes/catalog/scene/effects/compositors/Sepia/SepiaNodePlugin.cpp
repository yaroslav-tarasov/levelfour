...
//!
Node * SepiaNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new SepiaNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(Sepianodeplugin, SepiaNodePlugin)
