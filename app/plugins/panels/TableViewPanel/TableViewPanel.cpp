...
//!
void TableViewPanel::updateSelectedNode(Node * selectedNode)
{
	m_node = selectedNode;
...
//!
QListWidgetItem* TableViewPanel::addItem(Parameter *parameter, bool groupElement)
{
...
//!
void TableViewPanel::nodeSelected(QListWidgetItem * listItem)
{
