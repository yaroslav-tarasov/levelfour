...
{
	// NILZ: TEST:
	//std::cout << "topleftX: " << boundingRect().topLeft().x()
	//		  << "topleftY: " << boundingRect().topLeft().y()
	//		  << "bottomrightX: " << boundingRect().bottomRight().x()
	//		  << "bottomrightY: " << boundingRect().bottomRight().y();
	//std::cout << "Conn " << m_name.toStdString() << std::endl;
