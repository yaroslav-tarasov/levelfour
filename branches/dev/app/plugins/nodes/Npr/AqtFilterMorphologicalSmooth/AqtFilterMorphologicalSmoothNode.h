...
//!
//! \file "AqtFilterMorphologicalSmoothNode.h"
//! \brief Header file for AqtFilterMorphologicalSmoothNode class.
//!
...
#ifndef AQTFILTERMORPHOLOGICALSMOOTHNODE_H
#define AQTFILTERMORPHOLOGICALSMOOTHNODE_H
...
//!
class AqtFilterMorphologicalSmoothNode : public CompositorNode
{
...
public: // constructors and destructors
    ...
    //!
    AqtFilterMorphologicalSmoothNode ( const QString &name, ParameterGroup *parameterRoot );
    ...
    //!
    virtual ~AqtFilterMorphologicalSmoothNode ();
