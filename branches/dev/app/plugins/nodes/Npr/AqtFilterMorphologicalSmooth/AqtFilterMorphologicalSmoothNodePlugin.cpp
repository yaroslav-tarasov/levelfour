...
#include "AqtFilterMorphologicalSmoothNodePlugin.h"
...
//!
Node * AqtFilterMorphologicalSmoothNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new AqtFilterMorphologicalSmoothNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(AqtFilterMorphologicalSmoothNodePlugin, AqtFilterMorphologicalSmoothNodePlugin)
