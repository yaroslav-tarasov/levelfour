...
//!
//! \file "LightNodePlugin.h"
//! \brief Header file for LightNodePlugin class.
//!
...
#ifndef LIGHTNODEPLUGIN_H
#define LIGHTNODEPLUGIN_H
...
//!
class LightNodePlugin : public QObject, public NodeTypeInterface
{
