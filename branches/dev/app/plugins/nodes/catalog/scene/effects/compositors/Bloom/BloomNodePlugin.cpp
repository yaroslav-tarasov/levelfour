...
//!
Node * BloomNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new BloomNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(Bloomnodeplugin, BloomNodePlugin)
