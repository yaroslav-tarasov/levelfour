...
#include "AqtFilterBilateralSmoothNodePlugin.h"
...
//!
Node * AqtFilterBilateralSmoothNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new AqtFilterBilateralSmoothNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(AqtFilterBilateralSmoothNodePlugin, AqtFilterBilateralSmoothNodePlugin)
