...
//!
Node * LineDrawNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new LineDrawNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(LineDrawnodeplugin, LineDrawNodePlugin)
