...
#include "DropShadowNodePlugin.h"
...
//!
Node * DropShadowNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new DropShadowNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(DropShadownodeplugin, DropShadowNodePlugin)
