//!
//! \file "KuwaharaNode.cpp"
//! \brief Implementation file for KuwaharaNode class.
//!
...
//!
KuwaharaNode::KuwaharaNode ( const QString &name, ParameterGroup *parameterRoot ) :
    CompositorNode(name, parameterRoot)
{
    // create compositor
    if (m_viewport)
        m_compositor = Ogre::CompositorManager::getSingleton().addCompositor(m_viewport, "KuwaharaCompositor", 0);
...
//!
void KuwaharaNode::notifyMaterialRender(Ogre::uint32 pass_id, Ogre::MaterialPtr &mat)
{
...
//!
void KuwaharaNode::processOutputImage ()
{
    // obtain input image
    ...
    if (inputTexture.isNull()) {
        ...
        Log::warning("No input image connected.", "KuwaharaNode::processOutputImage");
    }
...
//!
void KuwaharaNode::redrawTriggered ()
{
