...
#include "CameraShakeNodePlugin.h"
#include "CameraShakeNode.h"
...
//!
Node * CameraShakeNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new CameraShakeNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(CameraShakenodeplugin, CameraShakeNodePlugin)
