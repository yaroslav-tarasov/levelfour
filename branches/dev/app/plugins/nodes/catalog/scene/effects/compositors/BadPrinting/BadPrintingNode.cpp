...
//!
//! \file "BadPrintingNode.cpp"
//! \brief Implementation file for BadPrintingNode class.
//!

#include "BadPrintingNode.h"
...
//!
BadPrintingNode::BadPrintingNode ( const QString &name, ParameterGroup *parameterRoot ) :
    CompositorNode(name, parameterRoot)
{
    // create compositor
    if (m_viewport)
        m_compositor = Ogre::CompositorManager::getSingleton().addCompositor(m_viewport, "BadPrintingCompositor", 0);
...
//!
BadPrintingNode::~BadPrintingNode ()
{
}
