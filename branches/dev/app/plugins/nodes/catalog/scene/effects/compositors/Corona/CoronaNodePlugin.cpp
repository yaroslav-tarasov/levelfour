...
//!
Node * CoronaNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new CoronaNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(Coronanodeplugin, CoronaNodePlugin)
