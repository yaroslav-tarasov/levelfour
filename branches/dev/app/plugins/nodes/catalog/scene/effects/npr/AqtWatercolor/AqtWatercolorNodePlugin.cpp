...
#include "AqtWatercolorNodePlugin.h"
...
//!
Node * AqtWatercolorNodePlugin::createNode ( const QString &name, ParameterGroup *parameterRoot )
{
    return new AqtWatercolorNode(name, parameterRoot);
}


Q_EXPORT_PLUGIN2(aqtwatercolornodeplugin, AqtWatercolorNodePlugin)
