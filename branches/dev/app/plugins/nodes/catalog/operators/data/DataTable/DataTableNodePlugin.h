...
//!
//! \file "DataTableNodePlugin.h"
//! \brief Header file for DataTableNodePlugin class.
//!
...
#ifndef DataTableNODEPLUGIN_H
#define DataTableNODEPLUGIN_H
...
//!
class DataTableNodePlugin : public QObject, public NodeTypeInterface
{
