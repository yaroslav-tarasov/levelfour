...
#include <ParameterTabPage>
#include <DoubleSlider>
#include <NodeFactory>
#include <Log>
/*
...
//!
void ListViewPanel::registerControl(NodeModel *nodeModel, SceneModel *sceneModel)
{
...
//!
void ListViewPanel::updateSelectedNode(Node * selectedNode)
{
	m_node = selectedNode;
...
//!
QListWidgetItem* ListViewPanel::addItem(Parameter *parameter, bool groupElement)
{
...
//!
void ListViewPanel::nodeSelected(QListWidgetItem * listItem)
{
