...
#define vtksys_DATE_STAMP_MONTH         12

/** Version date integer day.  The format is DD.  */
#define vtksys_DATE_STAMP_DAY           09

/** Version date full integer.  The format is CCYYMMDD.  */
#define vtksys_DATE_STAMP_FULL          20091209
...
#define vtksys_DATE_STAMP_STRING_MONTH "12"

/** Version date string day.  The format is "DD".  */
#define vtksys_DATE_STAMP_STRING_DAY   "09"

/** Version date full string.  The format is "CCYYMMDD".  */
#define vtksys_DATE_STAMP_STRING_FULL  "20091209"

/** Version date formatted string.  The format is "CCYY-MM-DD".  */
#define vtksys_DATE_STAMP_STRING       "2009-12-09"
