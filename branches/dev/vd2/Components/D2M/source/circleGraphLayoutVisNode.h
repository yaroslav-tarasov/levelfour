...
#ifndef CIRCLEGRAPHLAYOUTVISNODE_VIS_NODE_H
#define CIRCLEGRAPHLAYOUTVISNODE_VIS_NODE_H
...
class circleGraphLayoutVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    circleGraphLayoutVisNodeData* d;
    void calcLayout();
