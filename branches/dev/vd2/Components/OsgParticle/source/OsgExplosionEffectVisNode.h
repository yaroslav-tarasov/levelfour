...
#ifndef OSGEXPLOSIONEFFECTVISNODE_VIS_NODE_H
#define OSGEXPLOSIONEFFECTVISNODE_VIS_NODE_H
...
class OsgExplosionEffectVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgExplosionEffectVisNodeData* d;
};
