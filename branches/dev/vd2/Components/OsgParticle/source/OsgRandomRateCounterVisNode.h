...
#ifndef OSGRANDOMRATECOUNTERVISNODE_VIS_NODE_H
#define OSGRANDOMRATECOUNTERVISNODE_VIS_NODE_H
...
class OsgRandomRateCounterVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgRandomRateCounterVisNodeData* d;
};
