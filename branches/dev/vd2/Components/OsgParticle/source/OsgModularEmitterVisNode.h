...
#ifndef OSGMODULAREMITTERVISNODE_VIS_NODE_H
#define OSGMODULAREMITTERVISNODE_VIS_NODE_H
...
class OsgModularEmitterVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgModularEmitterVisNodeData* d;
};
