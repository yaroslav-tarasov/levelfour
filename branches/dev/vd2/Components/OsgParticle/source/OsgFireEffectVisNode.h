...
#ifndef OSGFIREEFFECTVISNODE_VIS_NODE_H
#define OSGFIREEFFECTVISNODE_VIS_NODE_H
...
class OsgFireEffectVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
