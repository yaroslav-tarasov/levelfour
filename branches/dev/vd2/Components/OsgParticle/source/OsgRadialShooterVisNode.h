...
#ifndef OSGRADIALSHOOTERVISNODE_VIS_NODE_H
#define OSGRADIALSHOOTERVISNODE_VIS_NODE_H
...
class OsgRadialShooterVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
