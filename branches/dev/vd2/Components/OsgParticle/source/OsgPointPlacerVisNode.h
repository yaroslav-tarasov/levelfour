...
#ifndef OSGPOINTPLACERVISNODE_VIS_NODE_H
#define OSGPOINTPLACERVISNODE_VIS_NODE_H
...
class OsgPointPlacerVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
