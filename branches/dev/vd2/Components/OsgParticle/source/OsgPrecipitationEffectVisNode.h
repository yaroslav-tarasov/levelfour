...
#ifndef OSGPRECIPITATIONEFFECTVISNODE_VIS_NODE_H
#define OSGPRECIPITATIONEFFECTVISNODE_VIS_NODE_H
...
class OsgPrecipitationEffectVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgPrecipitationEffectVisNodeData* d;
};
