...
#ifndef OSGFX_COMPONENT_H
#define OSGFX_COMPONENT_H
...
class OsgFXComponent : public GCF::AbstractComponent,
                                 virtual public IVisSystemNodeFactory,
                                 virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IVisSystemNodeFactory IAboutData)
    GCF_DECLARE_COMPONENT(OsgFXComponent)

public:
    static OsgFXComponent & instance();
    ~OsgFXComponent();
