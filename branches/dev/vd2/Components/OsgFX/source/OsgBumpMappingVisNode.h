...
#ifndef OSGBUMPMAPPINGVISNODE_VIS_NODE_H
#define OSGBUMPMAPPINGVISNODE_VIS_NODE_H
...
class OsgBumpMappingVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
