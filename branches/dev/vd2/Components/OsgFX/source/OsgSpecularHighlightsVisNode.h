...
#ifndef OSGSPECULARHIGHLIGHTSVISNODE_VIS_NODE_H
#define OSGSPECULARHIGHLIGHTSVISNODE_VIS_NODE_H
...
class OsgSpecularHighlightsVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgSpecularHighlightsVisNodeData* d;
};
