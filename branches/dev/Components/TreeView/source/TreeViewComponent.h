...
#ifndef TREEVIEWCOMPONENT_H
#define TREEVIEWCOMPONENT_H

#include <GCF/AbstractComponent>
#include <GCF/IAboutData>

struct TreeViewComponentData;
class TreeViewComponent : public GCF::AbstractComponent, virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IAboutData)
    GCF_DECLARE_COMPONENT(TreeViewComponent)

public:
    static TreeViewComponent & instance();
    ~TreeViewComponent();
