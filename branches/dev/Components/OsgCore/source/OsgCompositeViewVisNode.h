...
#ifndef OSGCOMPOSITEVIEWVISNODE_VIS_NODE_H
#define OSGCOMPOSITEVIEWVISNODE_VIS_NODE_H
...
class OsgCompositeViewVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
