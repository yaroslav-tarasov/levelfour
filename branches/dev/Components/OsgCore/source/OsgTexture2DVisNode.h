...
#ifndef OSGTEXTURE2DVISNODE_VIS_NODE_H
#define OSGTEXTURE2DVISNODE_VIS_NODE_H
...
class OsgTexture2DVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
