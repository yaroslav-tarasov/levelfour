...
#ifndef M2DCOMPONENT_H
#define M2DCOMPONENT_H

#include <GCF/AbstractComponent>
#include <GCF/IAboutData>

struct M2DComponentData;
class M2DComponent : public GCF::AbstractComponent, virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IAboutData)
    GCF_DECLARE_COMPONENT(M2DComponent)

public:
    static M2DComponent & instance();
    ~M2DComponent();
