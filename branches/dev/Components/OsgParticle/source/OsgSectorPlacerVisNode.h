...
#ifndef OSGSECTORPLACERVISNODE_VIS_NODE_H
#define OSGSECTORPLACERVISNODE_VIS_NODE_H
...
class OsgSectorPlacerVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
