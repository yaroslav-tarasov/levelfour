...
#ifndef OSGSEGMENTPLACERVISNODE_VIS_NODE_H
#define OSGSEGMENTPLACERVISNODE_VIS_NODE_H
...
class OsgSegmentPlacerVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
