...
#ifndef OSGSMOKEEFFECTVISNODE_VIS_NODE_H
#define OSGSMOKEEFFECTVISNODE_VIS_NODE_H
...
class OsgSmokeEffectVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
