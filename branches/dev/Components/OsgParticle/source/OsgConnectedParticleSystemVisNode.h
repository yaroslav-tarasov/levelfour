...
#ifndef OSGCONNECTEDPARTICLESYSTEMVISNODE_VIS_NODE_H
#define OSGCONNECTEDPARTICLESYSTEMVISNODE_VIS_NODE_H
...
class OsgConnectedParticleSystemVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    OsgConnectedParticleSystemVisNode();
    ~OsgConnectedParticleSystemVisNode();
...
private:
    OsgConnectedParticleSystemVisNodeData* d;
};
