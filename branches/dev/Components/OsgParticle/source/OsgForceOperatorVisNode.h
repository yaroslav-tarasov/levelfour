...
#ifndef OSGFORCEOPERATORVISNODE_VIS_NODE_H
#define OSGFORCEOPERATORVISNODE_VIS_NODE_H
...
class OsgForceOperatorVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
