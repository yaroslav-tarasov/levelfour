...
#ifndef OSGVIS_COMPONENT_H
#define OSGVIS_COMPONENT_H
...
class OsgVisComponent : public GCF::AbstractComponent,
                                 virtual public IVisSystemNodeFactory,
                                 virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IVisSystemNodeFactory IAboutData)
    GCF_DECLARE_COMPONENT(OsgVisComponent)

public:
    static OsgVisComponent & instance();
    ~OsgVisComponent();
