...
#include "SceneExporterComponent.h"
...
GCF_DEFINE_COMPONENT(SceneExporterComponent)

struct SceneExporterComponentData
{
    SceneExporterComponentData() : exportVRMLAction(0),
        contextMenuNode(0) { }
...
SceneExporterComponent & SceneExporterComponent::instance()
{
    static SceneExporterComponent* theInstance = GCF_CREATE_COMPONENT(SceneExporterComponent);
    return *theInstance;
}

SceneExporterComponent::SceneExporterComponent()
{
    d = new SceneExporterComponentData;
}
...
QAction* SceneExporterComponent::fetchAction(const QString& completeName) const
{
...
QObject* SceneExporterComponent::fetchObject(const QString& completeName) const
{
    QStringList comps = completeName.split('.');

    SceneExporterComponent* that = const_cast<SceneExporterComponent*>(this);
...
QWidget* SceneExporterComponent::fetchWidget(const QString& completeName) const
{
    QStringList comps = completeName.split('.');
...
void SceneExporterComponent::initializeComponent()
{
    // Do nothing.
}

void SceneExporterComponent::creationAnnounced()
{
...
void SceneExporterComponent::finalizeComponent()
{
    // Do nothing
}

QObject* SceneExporterComponent::containerObject()
{
    return this;
}

QString SceneExporterComponent::productName() const
{
    return "VRMLExporter";
}

QString SceneExporterComponent::organization() const
{
    return "My Organization";
}

QImage SceneExporterComponent::programLogo() const
{
    return QImage();
}

QString SceneExporterComponent::version() const
{
    return "1.0";
}

QString SceneExporterComponent::shortDescription() const
{
    return "Provides VRMLExporter";
}

QString SceneExporterComponent::homepage() const
{
    return "My Organization website";
}

QString SceneExporterComponent::bugAddress() const
{
    return "My Organization website";
}

const QList<GCF::AboutPerson> SceneExporterComponent::authors() const
{
    static QList<GCF::AboutPerson> retList;
    return retList;
}

const QList<GCF::AboutPerson> SceneExporterComponent::credits() const
{
    static QList<GCF::AboutPerson> retList;
    return retList;
}

QString SceneExporterComponent::license() const
{
    return "My Organization {{AppName}} License";
}

QString SceneExporterComponent::copyrightStatement() const
{
    return QString();
}

void SceneExporterComponent::slotNodeAdded(IVisSystemNode* node)
{
...
void SceneExporterComponent::slotNodeRemoved(IVisSystemNode* node)
{
...
void SceneExporterComponent::slotNodeContextMenuEvent(IVisSystemNode* node, QMenu* menu)
{
    if(!d->renWinNodeList.contains(node))
        return;
...
void SceneExporterComponent::exportVRML()
{
...
void SceneExporterComponent::exportVRML2()
{
...
void SceneExporterComponent::exportVRML(vtkRenderWindow* renWin)
{
    if(!renWin)
        return;
...
GCF_EXPORT_COMPONENT_PLUGIN(SceneExporterComponent)
