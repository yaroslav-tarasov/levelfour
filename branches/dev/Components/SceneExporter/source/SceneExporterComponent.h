...
#ifndef SceneExporterComponent_H
#define SceneExporterComponent_H
...
class SceneExporterComponent : public GCF::AbstractComponent, virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IAboutData)
    GCF_DECLARE_COMPONENT(SceneExporterComponent)

public:
    static SceneExporterComponent & instance();
    ~SceneExporterComponent();
