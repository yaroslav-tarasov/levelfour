...
#ifndef OSGOCCLUDERGEOMETRYVISNODE_VIS_NODE_H
#define OSGOCCLUDERGEOMETRYVISNODE_VIS_NODE_H
...
class OsgOccluderGeometryVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgOccluderGeometryVisNodeData* d;
};
