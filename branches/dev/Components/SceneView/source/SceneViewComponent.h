...
#ifndef SCENEVIEWCOMPONENT_H
#define SCENEVIEWCOMPONENT_H

#include <GCF/AbstractComponent>
#include <GCF/IAboutData>

struct SceneViewComponentData;
class SceneViewComponent : public GCF::AbstractComponent, virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IAboutData)
    GCF_DECLARE_COMPONENT(SceneViewComponent)

public:
    static SceneViewComponent & instance();
    ~SceneViewComponent();
