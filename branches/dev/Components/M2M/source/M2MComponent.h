...
#ifndef M2MCOMPONENT_H
#define M2MCOMPONENT_H

#include <GCF/AbstractComponent>
#include <GCF/IAboutData>

struct M2MComponentData;
class M2MComponent : public GCF::AbstractComponent, virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IAboutData)
    GCF_DECLARE_COMPONENT(M2MComponent)

public:
    static M2MComponent & instance();
    ~M2MComponent();
