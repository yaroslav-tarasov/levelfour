...
CVtkRenderWindow::CVtkRenderWindow() : m_vtkRenderWindow(0), m_lastPokedRenderer(0), m_mousePressed(false)
{
    ...
    setVtkObject(m_vtkWidget->GetRenderWindow());
    m_vtkWidget->installEventFilter(this);
    m_vtkWidget->GetRenderWindow()->AddObserver(vtkCommand::StartEvent, &RenderWindowMonitor());
    m_vtkWidget->GetRenderWindow()->AddObserver(vtkCommand::EndEvent, &RenderWindowMonitor());
...
QVTKWidget* CVtkRenderWindow::vtkWidget() const
{
    return m_vtkWidget;
}
