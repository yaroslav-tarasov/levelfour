...
#ifndef PROPERTYINSPECTORCOMPONENT_H
#define PROPERTYINSPECTORCOMPONENT_H

#include <GCF/AbstractComponent>
#include <GCF/IAboutData>

struct PropertyInspectorComponentData;
class PropertyInspectorComponent : public GCF::AbstractComponent, virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IAboutData)
    GCF_DECLARE_COMPONENT(PropertyInspectorComponent)

public:
    static PropertyInspectorComponent & instance();
...
private:
    PropertyInspectorComponentData* d;
};
