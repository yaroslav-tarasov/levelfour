...
#ifndef OSGSCENEVISNODE_VIS_NODE_H
#define OSGSCENEVISNODE_VIS_NODE_H
...
class OsgSceneVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgSceneVisNodeData* d;

	osg::QOSGScene * createTestScene();
	osg::QOSGScene * createDefaultSceneFromActor(vtkActor * actor);
};
