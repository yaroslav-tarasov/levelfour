...
#ifndef OSGINFINITEPLANEVISNODE_VIS_NODE_H
#define OSGINFINITEPLANEVISNODE_VIS_NODE_H
...
class OsgInfinitePlaneVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
