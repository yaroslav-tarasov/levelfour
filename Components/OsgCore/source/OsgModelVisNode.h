...
#ifndef OSGMODELVISNODE_VIS_NODE_H
#define OSGMODELVISNODE_VIS_NODE_H
...
class OsgModelVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
#endif
{
    ...
    Q_PROPERTY(QString Model READ source WRITE setSource)
