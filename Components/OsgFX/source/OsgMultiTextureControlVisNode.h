...
#ifndef OSGMULTITEXTURECONTROLVISNODE_VIS_NODE_H
#define OSGMULTITEXTURECONTROLVISNODE_VIS_NODE_H
...
class OsgMultiTextureControlVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgMultiTextureControlVisNodeData* d;
};
