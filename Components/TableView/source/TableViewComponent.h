...
class TableViewComponent : public GCF::AbstractComponent, virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IAboutData)
    GCF_DECLARE_COMPONENT(TableViewComponent)

public:
    static TableViewComponent & instance();
    ~TableViewComponent();
