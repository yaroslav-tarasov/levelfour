...
#ifndef OSGCENTEREDPLACERVISNODE_VIS_NODE_H
#define OSGCENTEREDPLACERVISNODE_VIS_NODE_H
...
class OsgCenteredPlacerVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgCenteredPlacerVisNodeData* d;
};
