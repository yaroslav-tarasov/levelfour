...
#ifndef OSGVARIABLERATECOUNTERVISNODE_VIS_NODE_H
#define OSGVARIABLERATECOUNTERVISNODE_VIS_NODE_H
...
class OsgVariableRateCounterVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgVariableRateCounterVisNodeData* d;
};
