...
#ifndef OSGBOXPLACERVISNODE_VIS_NODE_H
#define OSGBOXPLACERVISNODE_VIS_NODE_H
...
class OsgBoxPlacerVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
