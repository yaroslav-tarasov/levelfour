...
#ifndef OSGBILLBOARDVISNODE_VIS_NODE_H
#define OSGBILLBOARDVISNODE_VIS_NODE_H
...
class OsgBillboardVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
