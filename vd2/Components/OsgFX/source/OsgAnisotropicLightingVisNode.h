...
#ifndef OSGANISOTROPICLIGHTINGVISNODE_VIS_NODE_H
#define OSGANISOTROPICLIGHTINGVISNODE_VIS_NODE_H
...
class OsgAnisotropicLightingVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    OsgAnisotropicLightingVisNodeData* d;
};
