...
#ifndef OSGSHADOW_COMPONENT_H
#define OSGSHADOW_COMPONENT_H
...
class OsgShadowComponent : public GCF::AbstractComponent,
                                 virtual public IVisSystemNodeFactory,
                                 virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IVisSystemNodeFactory IAboutData)
    GCF_DECLARE_COMPONENT(OsgShadowComponent)

public:
    static OsgShadowComponent & instance();
    ~OsgShadowComponent();
